...
public class SendDataToServer_reservation_Map extends AsyncTask<Void, Void, String> {
    private String id;
    ...
    public SendDataToServer_reservation_Map(String id, String attractionName) {
        this.id = id;
    ...
    protected String doInBackground(Void... params) {
        try {
            String Url = "http://118.217.128.115:8080/reservation/reservateAttraction";
            ...
            try{
                ...
                postData.put("attractionName", attractionName);
