...
public class SendDataToServer_reservation extends AsyncTask<Void, Void, String> {
    private int number;
    //true면 예약 false면 취소
    private boolean checkOrCancel;
    String reTrun;

    // 생성자를 통해 전송할 데이터를 받아옴
    public SendDataToServer_reservation(int number, boolean checkOrCancel) {
        this.checkOrCancel = checkOrCancel;
        this.number = number;
    }
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            // 내가 연결하려는 URL생성
            URL url = new URL("http://118.217.128.115:8080/api/member/login");
            ...
            try{
                ...
                postData.put("checkOrCancel",checkOrCancel);
