...
public class SendDataToServer_Table extends AsyncTask<Void, Void, String> {
    private String id;

    String reTrun;

    // 생성자를 통해 전송할 데이터를 받아옴
    public SendDataToServer_Table(String id) {
        this.id = id;
    }
    ...
    protected String doInBackground(Void... params) {
        try {
            ...
            String Url = "http://118.217.128.115:8080/reservation/table/"+id;
