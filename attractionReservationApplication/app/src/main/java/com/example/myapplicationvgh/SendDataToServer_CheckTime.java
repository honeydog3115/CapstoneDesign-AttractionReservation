...
public class SendDataToServer_CheckTime extends AsyncTask<Void, Void, String> {
    private String id;

    String reTrun;

    // 생성자를 통해 전송할 데이터를 받아옴
    public SendDataToServer_CheckTime(String id) {
        this.id = id;
    }
    ...
    protected String doInBackground(Void... params) {
        try {
            String Url = "http://118.217.128.115:8080/reservation/info/"+id;
            System.out.println("checkTime_id = " + id);
            // 내가 연결하려는 URL생성
            URL url = new URL(Url);
