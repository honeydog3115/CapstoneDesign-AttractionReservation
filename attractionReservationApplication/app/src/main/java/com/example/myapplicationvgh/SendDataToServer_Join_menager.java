...
public class SendDataToServer_Join_menager extends AsyncTask<Void, Void, String> {
    private String name;
    private String id;
    private String pw;
    ...
    public SendDataToServer_Join_menager(String name, String id, String pw, String attraction) {
        this.name = name;
        this.id = id;
        this.pw = pw;
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            // 내가 연결하려는 URL생성
            URL url = new URL("http://118.217.128.115:8080/manager/signup");
            ...
            try{
                ...
                postData.put("id", id);
                postData.put("pw", pw);
                postData.put("attraction", attraction);
