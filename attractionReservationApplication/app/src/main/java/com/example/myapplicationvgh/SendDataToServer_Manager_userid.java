...
public class SendDataToServer_Manager_userid extends AsyncTask<Void, Void, String> {
    ...
    public SendDataToServer_Manager_userid(String userId,String managerId) {
        this.userId = userId;
    ...
    protected String doInBackground(Void... params) {
        try {
            String Url = "http://118.217.128.115:8080/reservation/check/"+userId + "/" +managerId;
            System.out.println("checkTime_id = " + userId);
            // 내가 연결하려는 URL생성
            URL url = new URL(Url);
